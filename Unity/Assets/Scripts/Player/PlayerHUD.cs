...
{
    [Header("Refs")]
    public CanvasGroup canvasGroup;             // PlayerHUD 上的 CanvasGroup
    public Animator workIndicatorAnimator;      // WorkIndicator 上的 Animator
    public StatusPopupSpawner statusPopup;

    [Header("Working Indicator")]
    public bool hideHudWhenIdle = false;        // 没事时是否整体隐藏HUD
